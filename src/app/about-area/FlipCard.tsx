  ...
  return (
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="[perspective:1500px]">
        <motion.div
          className="relative h-[340px] w-[560px] [transform-style:preserve-3d]"
          animate={{ rotateY: isFlipped ? 180 : 0 }}
          transition={{ duration: 0.8, type: "spring", bounce: 0.25 }}
        >
          {/* 表面：名刺 */}
          <div className="absolute inset-0 flex items-center gap-8 rounded-2xl bg-white px-10 shadow-2xl [backface-visibility:hidden]">
            <Image
            ...
            <div className="flex flex-col gap-2 text-gray-800">
              ...
              <p className="text-3xl font-bold">Motoji Saki</p>
          ...
          {/* 裏面：自己紹介 */}
          <div className="absolute inset-0 flex items-center rounded-2xl bg-gray-800 px-10 shadow-2xl [backface-visibility:hidden] [transform:rotateY(180deg)]">
