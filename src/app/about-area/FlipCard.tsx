    ...
    <div className="flex flex-col items-center gap-6 px-4 w-full">
      <div className="w-full max-w-[560px] aspect-[560/340] [container-type:inline-size]">
        ...
        <div className="h-full w-full text-[calc(100cqw/35)] [--spacing:0.25em] [perspective:93.75em]">
          ...
          >
            {/* 表面：名刺 */}
            <div className="absolute inset-0 flex flex-col overflow-hidden rounded-[2.5em] bg-[#fff7fb] shadow-2xl [backface-visibility:hidden]">
              {/* 上部：チェック柄 + レース + リボン */}
            ...
            {/* 裏面 */}
            <div
              className="absolute inset-0 overflow-hidden rounded-[2.5em] shadow-2xl [backface-visibility:hidden] [transform:rotateY(180deg)]"
              style={{
